...
class ServerController:
    ...
    def start_event_loop(self ,callback):
        ...
        async def start():
            ...
            self.main_routine = asyncio.create_task(self.check_function_queue())
    ...
    async def teste(self):
        print("O teste tá rodando minha flor!!")
    ...
    def _enqueue(self, func, *args, callback=None):
        try:
            self.loop.call_soon_threadsafe(self.function_queue.put_nowait, # type: ignore
