...
class ServerConnection(BaseConnection):
    ...
    """
        ...
        It stores  the messages broadcast to all connections and is ables to create new notifications objects.
        It operates two asynchronous tasks: the server listener and a schedule 
        that verify the broadcast queue to collect new messages to send them all to the 
